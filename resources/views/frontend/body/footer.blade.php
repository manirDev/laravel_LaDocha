                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div class="module-body">
                        <ul class='list-unstyled'>
                            ...
                            <li><a href="{{route('reference')}}" title="References">References</a></li>
        ...
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-padding social">
                <ul class="link">
                    ...
                    <li class="googleplus pull-left"><a target="_blank" rel="nofollow" href="{{$setting->instagram}}" title="GooglePlus"></a></li>
                    <li class="linkedin pull-left"><a target="_blank" rel="nofollow" href="{{$setting->facebook}}" title="Linkedin"></a></li>
